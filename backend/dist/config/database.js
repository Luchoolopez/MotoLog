...
if (process.env.DATABASE_URL) {
    exports.sequelize = sequelize = new sequelize_1.Sequelize(process.env.DATABASE_URL, commonOptions);
}
else {
    exports.sequelize = sequelize = new sequelize_1.Sequelize(requireEnv('DB_NAME'), requireEnv('DB_USER'), requireEnv('DB_PASSWORD'), {
        ...commonOptions,
