...
const alert_reminder_model_1 = require("./alert_reminder.model");
const setupAssociations = () => {
    ...
    user_model_1.User.hasMany(alert_reminder_model_1.AlertReminder, {
        foreignKey: 'user_id',
        as: 'alertas_pospuestas'
    });
    alert_reminder_model_1.AlertReminder.belongsTo(user_model_1.User, {
        foreignKey: 'user_id',
        as: 'usuario'
    });
};
